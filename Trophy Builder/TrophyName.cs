...
{
    public class TrophyName : TextField

    {
        ...
        {
            spriteBatch.DrawString(font, "Trophy Name:", new Vector2(x - 110, y + 15),Color.White);
            ...
            spriteBatch.Draw(textboxImage, new Vector2(x + 4, y), new Rectangle(2, 0, 100, 48), Color.White, 0, new Vector2(0, 0), new Vector2(7,1), SpriteEffects.None, bttnLevel);
            spriteBatch.Draw(textboxImage, new Vector2(x + 704, y), new Rectangle(102, 0, 2, 48), Color.White, 0, new Vector2(0, 0), 1, SpriteEffects.None, bttnLevel);
        ...
        public void Update()
        {
            ...
            {
                listOfTrophyItems[trophySelected].trophyName = fieldText;
            }
            else
            {
                fieldText = "";
